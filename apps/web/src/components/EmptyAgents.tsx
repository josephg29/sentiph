...
export type AgentAnimation = "idle" | "sway" | "walk" | "jog" | "swim-up" | "bounce" | "float";
// "sleepy" is reserved for idle/inactive agents — never assign it randomly on creation.
export type AgentExpression = "normal" | "happy" | "sleepy" | "angry" | "surprised";
export type AgentAccessory = "none" | "long" | "mohawk" | "side-sweep" | "curly";

// Backward-compat aliases (keep existing imports working during transition)
export type OctopusAnimation = AgentAnimation;
export type OctopusAccessory = AgentAccessory;
...
const HEADS: Record<AgentExpression, string[][]> = {
